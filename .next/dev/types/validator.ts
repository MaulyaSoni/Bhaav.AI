...
// Validate ../../../app/api/analyze/text/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/analyze/text">> = Specific
  const handler = {} as typeof import("../../../app/api/analyze/text/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
